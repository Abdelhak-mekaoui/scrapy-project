...
class ScrapeOpsFakeUserAgentMiddleware:
    ...
    def _get_user_agents_list(self):
        ...
        self._get_user_agents_list = json_response.get('result',[])

    def _get_random_user_agent(self):
        random_index = randint(0, len(self._get_user_agents_list)-1)
        return self._get_user_agents_list[random_index]
...
class ScrapeOpsFakeBrowserHeaderAgentMiddleware:
    ...
    def _get_headers_list(self):
        ...
        response = requests.get(self.scrapeops_endpoint, params=urlencode(payload))
        json_response = response.json()
        self._get_headers_list = json_response.get('result',[])

    def _get_random_browser_header(self):
        random_index = randint(0, len(self._get_headers_list)-1)
        return self._get_headers_list[random_index]
